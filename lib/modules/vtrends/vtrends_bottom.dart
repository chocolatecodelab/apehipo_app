...
class VtrendsBottom extends StatefulWidget {
  final String? rincian;

  const VtrendsBottom(this.rincian);
  @override
  _VtrendsBottomState createState() => _VtrendsBottomState();
}

class _VtrendsBottomState extends State<VtrendsBottom> {
  @override
