...
class AccountTokoScreen extends StatefulWidget {
  @override
  _AccountTokoScreenState createState() => _AccountTokoScreenState();
}

class _AccountTokoScreenState extends State<AccountTokoScreen> {
