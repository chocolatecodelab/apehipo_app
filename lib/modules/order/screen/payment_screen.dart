...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  String urlBuktiPembayaran = "https://apehipodev.online/api/bukti_pembayaran/";
  ...
  void initState() {
    super.initState();
    // if (!widget.buktiPembayaran!
    //     .startsWith('https://apehipodev.online/api/bukti_pembayaran/')) {
    //   _selectedImage?.path = widget.buktiPembayaran;
    // }
  }
                            ...
                            Align(
                              ...
                              child: Container(
                                child: ElevatedButton(
                                  onPressed: widget.buktiPembayaran! ==
                                          urlBuktiPembayaran
                                      ? () {
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    elevation: 0,
                                    backgroundColor: widget.buktiPembayaran! ==
                                            urlBuktiPembayaran
  ...
  Widget getImageBukti(XFile? _selectedImage, String? foto) {
    if (foto == "https://apehipodev.online/api/bukti_pembayaran/") {
      foto =
          "https://img.freepik.com/free-vector/hand-drawn-no-data-illustration_23-2150544943.jpg?t=st=1713961396~exp=1713964996~hmac=426e1c0c966c6314090f562bed3ca831f89abffda3f65415c2efbf1bc666a85f&w=740";
    }
    return Container(
      child: ClipRRect(
